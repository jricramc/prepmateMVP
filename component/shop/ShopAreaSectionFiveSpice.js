...
import ProductContainerFiveSpice from './ProductContainerFiveSpice.js'

const ShopAreaSectionFiveSpice = () => {
  return (
...
export default ShopAreaSectionFiveSpice