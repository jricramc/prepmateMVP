      ...
      <ul className={`align-items-center ${position}`}>
        <li className="fz-dropdown fz-nav-item">
          <a role="button" className="fz-nav-link">
            <span>shop restaurants</span> <i className="fa-regular fa-plus"></i>
          </a>

          <ul className="fz-submenu">
            <li>
              <Link href="/millShop" className="fz-nav-link fz-submenu-nav-link">
                Mill City
              </Link>
            </li>
            <li>
              <Link href="/lifealiveShop" className="fz-nav-link fz-submenu-nav-link">
                Life Alive
              </Link>
            </li>
            <li>
              <Link href="/silkroadShop" className="fz-nav-link fz-submenu-nav-link">
                Silk Road Cuisine
              </Link>
            </li>
            <li>
              <Link href="/delightShop" className="fz-nav-link fz-submenu-nav-link">
                Spice Delight
              </Link>
            </li>
          </ul>
        ...
        <li className="fz-nav-item">
          <Link href="/contact" className="fz-nav-link">
            Contact
          </Link>
          <span style={{ marginLeft: '60px' }}>Minimum order amount: 4 meals</span>

        </li>
      </ul>
      {/* <p style={{ marginTop: '10px' }}>Minimum order amount: 4 meals</p> */}
    </nav>
  )
}
